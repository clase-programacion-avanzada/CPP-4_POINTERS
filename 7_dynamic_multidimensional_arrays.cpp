...
int main() {
    ...
    /*
    In c++, we can define multi-dimensional arrays with a fixed size, or with a dynamic size.
    We wil be creating a dynamic multi-dimensional array.
    This will be a table with 5 rows and a different number of columns for each row.
        0 1 2 3 4
    0:  []
    1:  [][]
    2:  [][][]
    ...
    */
    ...
    int size = 5;
    //We need to use double star and the type of the array to create a dynamic array
    //First we create an array of pointers
